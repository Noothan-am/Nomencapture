                  ...
                  <section className={styles["nomen-name-container"]}>
                    ...
                    <div className={styles["nomen-rightpart"]}>
                      ...
                      <div className={styles["bottom-part"]}>
                        <p>
                          <span></span>
                          The rhythmic repitition of ‘u’ ‘a’ and ‘n’ sounds
                          offer a sense of fluidity, softness, pleasantness and
                          positivity
                        </p>
                      </div>
                    </div>
                ...
                <p>(As per Ministry of Commerce LLP Database)</p>
                  ...
                  <div className={styles["name-description"]}>
                    ...
                    <span>
                      ...
                      Harnessing the inherent power of grains is evident in
                      their range of health-conscious offerings.
                    </span>
                  </div>
                </div>
              </div>
